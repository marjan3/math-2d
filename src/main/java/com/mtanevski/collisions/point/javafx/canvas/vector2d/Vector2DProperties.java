...
import com.mtanevski.collisions.point.javafx.utils.ReadOnlyStringConverter;
...
public class Vector2DProperties {
    ...
    public Vector2DProperties(ObjectProperty<Vector2D> vector2DProperty) {
        ...
        try {
            URL resource = Vector2DProperties.class.getClassLoader().getResource("vector2d/properties.fxml");
