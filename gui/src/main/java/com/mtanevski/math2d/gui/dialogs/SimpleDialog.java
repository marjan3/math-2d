...
public class SimpleDialog extends Dialog<List<String>> {
    ...
    private SimpleDialog(String title, Map<String, Control> properties) {
        ...
        Platform.runLater(properties.values().stream().findFirst().get()::requestFocus);
    ...
    public static SimpleDialogResult showXYDialog(String title) {
        return SimpleDialog.showXYDialog(title, null, null, null);
    }

    public static SimpleDialogResult showNameDialog(String title) {
        ...
        var newDialogResult = new SimpleDialogResult();
        if (result.isEmpty()) {
    ...
    public static SimpleDialogResult showXYDialog(String title, String name, Double x, Double y) {
        var properties = new LinkedHashMap<String, Control>();
        var nameField = new TextField();
